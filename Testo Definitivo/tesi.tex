...
\section{Evoluzione temporale dei dischi e instabilità}
	...
	Questa gerarchia si dimostra essere corretta ed è un'ulteriore conferma che l'ipotesi che la materia del disco percorra orbite circa kepleriane è corretta.
	...
	La netta distinzione fra i tempi scala permette di distinguere di conseguenza diversi tipi di perturbazione che può interessare il disco, evidenziando magari delle instabilità.
...
\section{Evidenze dell'instabilità del modello di Shakura e Sunyaev}
	...
	Questo si può apprezzare osservando come, inserendo nell'equazione di diffusione della densità superficiale del disco l'equazione che descrive il momento torcente subito dal disco $G(R)\sim\alpha P_r$ per le regioni interne, si arriva ad un'equazione per l'evoluzione di $\Sigma(r,t)$
	\begin{equation*}
...
\newpage
\section{Oltre il modello di Shakura e Sunyaev}
Dopo di questo---
...
E' un ambito più legato a modelli e confronto con le osservazioni, che teorico...
